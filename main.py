...
def index():
    #Authorization
    #auth_url = getData.app_Authorization()
    return redirect(getData.REDIRECT_URI)

@app.route("/callback/q")
def callback():
    authorization_header = getData.user_Authorization()

    DANGERZONE = getData.getAudioAnalysis('34x6hEJgGAOQvmlMql5Ige', authorization_header)
